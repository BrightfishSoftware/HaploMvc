...
use HaploMvc\App;
use HaploMvc\Exception\LangFileNotFoundException;
use HaploMvc\Exception\TranslationKeyNotFoundException;
...
class Translator
{
    ...
    public function __construct(App $app)
    {
        ...
        if (!file_exists($this->file)) {
            ...
            if (file_exists($this->file)) {
                ...
                throw new LangFileNotFoundException("Specified language file ($this->lang) and default ($this->defaultLang) do not exist.");
            }
        }
        
        $this->cacheFile = $this->translationsCacheDir.'/HaploTranslator_'.md5($this->lang).'.cache';
    ...
    public function get($key)
    {
        ...
        throw new TranslationKeyNotFoundException("Translation key ($key) does not exist in selected language file($this->file).");
    }
}
