...
use HaploMvc\App;
use HaploMvc\Exception\ConfigParseFileException;
...
class Config
{
     ...
     * or default
     *
     * @throws ConfigParseFileException
     * @return array
     */
    protected function getEnvironments()
    {
        ...
        if (file_exists($environmentsFile)) {
            ...
            if (!empty($environments)) {
                ...
                throw new ConfigParseFileException("Couldn't parse environment file ($environmentsFile)");
            }
        }
    }
    ...
    protected function parseFiles($path, array $files)
    {
        foreach ($files as $file) {
            ...
            if (!empty($config)) {
                ...
                throw new ConfigParseFileException("Couldn't parse configuration file ($path/$file)");
            }
        }
    }
