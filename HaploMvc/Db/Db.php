...
class Db
{
     ...
     */
    public function __construct(App $app, DbDriver $driver)
    {
        $this->app = $app;
        $this->driver = $driver;
    }
     ...
     * @return bool|object
     */
    public function getArray($stmt, array $params = [], $start = 0, $count = 0)
    {
        if (is_null($this->db) && !$this->connect()) {
            return false;
        }
     ...
     * @return array
     */
    public function getList($sql, array $params = [])
    {
     ...
     * @return bool|object
     */
    public function getRow($stmt, array $params = [])
    {
        if (is_null($this->db) && !$this->connect()) {
            return false;
        }
     ...
     * @return bool
     */
    public function getColumn($stmt, array $params = [], $column = 0)
    {
        if (is_null($this->db) && !$this->connect()) {
            return false;
        }
     ...
     * @return bool
     */
    public function getRecordset($stmt, array $params = [], $start = 0, $count = 0)
    {
        if (is_null($this->db) && !$this->connect()) {
            return false;
        }
     ...
     * @return bool
     */
    public function run($stmt, array $params = [])
    {
        if (is_null($this->db) && !$this->connect()) {
            return false;
        }
